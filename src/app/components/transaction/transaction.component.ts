...
export class TransactionComponent implements OnInit {
  ...
  constructor(    private fb: FormBuilder, private walletService: WalletService, private router: Router, private toastrService: ToastrService) { }
  ...
  executeTransaction() {
    ...
    this.walletService.executeTransaction(payload, walletId).subscribe(data => {
      ...
      this.toastrService.error(error?.error || 'Something Went Wrong', "Error",{
        timeOut:3000
      });
    });
  }
